...
// PRD handles the `ralph prd` subcommand. This is an internal command used by
// the shell function to create a PRD after workspace creation. It is not
// documented in `ralph help`.
